...
func FileSliceUploadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FileSliceUploadRequest
		...
		l := logic.NewFileSliceUploadLogic(r.Context(), svcCtx)
		resp, err := l.FileSliceUpload(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
